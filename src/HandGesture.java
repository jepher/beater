...
public class HandGesture extends JFrame implements Runnable, MouseListener, KeyListener{
	...
	private String[] gestureTypes = new String[]{"Fist","Hand","One","Straight", "Palm", "Thumbs", "None", "Swing", "Peace"}; //types of gestures
	...
	private int gestureIndex = 0; //Gesture index to collect data for
	private String realTimePath = "D:/Documents/Programming/Hand Gestures/datasets/" + gestureTypes[gestureIndex]; //PICK A REAL TIME PATH LOCATION. Python's client will need this location
	private int currentGestureIndex = 0; //default to NONE
